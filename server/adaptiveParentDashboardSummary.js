...
async function buildAdaptiveParentDashboardSummary(pool, opts = {}) {
  ...
  return {
    ...
    latest_assessment_raw_score: journey.history.scores.latest_raw_score,
    latest_assessment_maximum_score: journey.history.scores.latest_maximum_score,
    latest_assessment_completed_at: journey.history.completion_timestamps.latest_assessment_completed_at,
    ...
    attempts: journey.history.attempts.assessment_attempts,
