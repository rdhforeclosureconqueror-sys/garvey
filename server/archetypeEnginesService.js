...
const { createAssessmentEngine } = require("../assessment-core/assessmentEngineFactory");
...
const LOYALTY_COMMUNICATION_RULES = Object.freeze({
  TD: Object.freeze({
    ...
    plain_language_summary: "You tend to form loyalty when someone feels steady, dependable, and emotionally safe over time.",
    best_way_to_talk_to_them: "Trust often builds for you through calm honesty, clear intentions, and follow-through that matches words.",
    what_keeps_them_engaged: "You often stay when consistency, accountability, and reliability keep showing up in the relationship.",
    what_pushes_them_away: "You may pull away when things feel unpredictable, promises break, or trust feels hard to restore.",
  ...
  SA: Object.freeze({
    ...
    plain_language_summary: "You tend to grow loyal when the relationship keeps feeling mutually worthwhile and emotionally fair.",
    best_way_to_talk_to_them: "Trust often builds for you when care is felt through steady quality, reciprocity, and meaningful effort.",
    what_keeps_them_engaged: "You often stay when the connection keeps returning value for your time, energy, and emotional investment.",
    what_pushes_them_away: "You may pull away when effort feels one-sided or when consistency and quality begin to fade.",
  ...
  ECM: Object.freeze({
    ...
    plain_language_summary: "Loyalty tends to feel deeply personal for you, and it often grows where emotional connection feels real.",
    best_way_to_talk_to_them: "Trust often builds for you through emotional presence, authenticity, and feeling genuinely understood.",
    what_keeps_them_engaged: "You often stay when warmth, recognition, and emotional resonance remain steady in the relationship.",
    what_pushes_them_away: "You may pull away when interactions feel performative, emotionally distant, or manipulative.",
  ...
  CH: Object.freeze({
    ...
    plain_language_summary: "You tend to become loyal where connection feels easy, natural, and sustainable in your day-to-day flow.",
    best_way_to_talk_to_them: "Trust often builds for you when interactions feel simple, clear, and emotionally low-friction.",
    what_keeps_them_engaged: "You often stay when routines feel smooth, practical, and easy to maintain over time.",
    what_pushes_them_away: "You may pull away when the relationship starts to feel complicated, draining, or consistently effortful.",
  ...
  SF: Object.freeze({
    ...
    plain_language_summary: "You tend to stay loyal through difficulty, especially when change feels costly or emotionally disruptive.",
    best_way_to_talk_to_them: "Trust often builds for you through practical clarity, emotional steadiness, and realistic expectations.",
    what_keeps_them_engaged: "You often stay when the relationship feels stable enough to justify continued commitment.",
    what_pushes_them_away: "You may pull away when resentment accumulates and an easier path finally feels available.",
...
function resolveLoveQuestionBanks(opts = {}) {
...
const LOVE_ENGINE = createAssessmentEngine({
  engineType: "love",
  resolveQuestionBank: resolveLoveQuestionBanks,
  scoreAssessment: (answers = {}, opts = {}) => {
    ...
    return withInsights("love", scoreCanonicalAssessment(bankScopedQuestions, answers));
  },
});

const LOYALTY_ENGINE = createAssessmentEngine({
  engineType: "loyalty",
