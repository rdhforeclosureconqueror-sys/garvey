(function(root,factory){if(typeof module==='object'&&module.exports){module.exports=factory();}else{root.SkillPackageSchema=factory();}})(typeof self!=='undefined'?self:this,function(){
  const QUESTION_TYPES=['multiple_choice','short_response','matching','letter_identification','sound_match','picture_choice','visual_objects','number_sequence','number_line','comparison','comparison_cards','base_ten_blocks','place_value_chart','expanded_form','addition_model','subtraction_model','number_bond','ten_frame','shape_identification','measurement_comparison','pattern_completion','sorting_visual','analog_clock','digital_time','time_matching','sound_position','same_different_sound','word_builder','sound_box_blend','decode_word','word_family_sort','rhyme_match','sight_word_match','sentence_cloze','phrase_reading','sentence_picture_match','punctuation_reading','text_evidence_choice','wh_question','event_ordering','picture_order','sequence_select','sentence_builder','capitalization_fix','spacing_fix','punctuation_choice','constructed_sentence','picture_prompt_response','detail_picker','rubric_scored_writing'];
  const VISUAL_MODELS=['visual_objects','letter_card','sound_match','picture_choice','phonics_tiles','sound_boxes','word_card','sentence_card','number_sequence','number_line','number_line_0_120','comparison','comparison_cards','base_ten_blocks','place_value_chart','expanded_form','addition_model','subtraction_model','number_bond','ten_frame','shape_identification','measurement_comparison','pattern_completion','sorting_visual','analog_clock','digital_time','time_matching','word_sound_map','word_builder','word_family_sort','rhyme_match','sentence_highlight','phrase_builder','sentence_builder','short_passage','picture_story','question_card','story_sequence','picture_order','event_cards','writing_checklist','punctuation_marker','picture_prompt','detail_picker'];
