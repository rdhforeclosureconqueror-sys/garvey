...
function renderYouthLeadershipResult(app, engine, primary, secondary, payload, query, resultId) {
  ...
  app.innerHTML = `
    ...
    <section class="section leadership-youth-program-path"><h2>Continue Into My Program</h2><p class="muted">This opens the 12-week Leader Within program overview. It opens curriculum only; enrollment records and saved progress are not live yet.</p><a class="simba-dashboard-return" href="/the-leader-within/programs/12-week.html">Continue Into My Program</a></section>
