...
const CONTENT_SCHEMA_FIELDS = Object.freeze([
  'name','code','emoji','coreEnergy','tagline','description','shortDescription','coreTrait','whenStrong','outOfBalanceHigh','outOfBalanceLow','coreStrengths','blindSpots','needsToStayBalanced','dailyBuildUps','weeklyBuildUps','balanceSignals','visualDirection','imageKey'
]);
...
module.exports = {
  ...
  RESULT_SCHEMA: { primaryArchetype: 'object', secondaryArchetype: 'object', normalizedScores: 'object', balanceState: 'string', primaryInsight: 'string', secondaryInsight: 'string', balanceInsight: 'string', stressInsight: 'string', identityGapInsight: 'string', consistencyInsight: 'string' },
